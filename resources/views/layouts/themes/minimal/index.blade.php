<?php $concaveconfig  = config('concave');?>
...
<head>
    ...
    <!-- Legacy  Custom CSS for old concave layout -->
    ...
    <script src="{{ asset('')}}assets/template/js/concave5.js"></script>   
    ...
    <!--[if lt IE 9]>
      ...
      @if(config('concave.cnf_maps') !='')
      <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=<?php echo config('concave.cnf_maps');?>">
      </script>
      @endif
...
<div class="modal fade" id="concave-modal" tabindex="-1" role="dialog">
