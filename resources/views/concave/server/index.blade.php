		...
		<div class="sbox bg-gray"  >
			<div class="sbox-title"> <h4><i class="fa fa-recycle"></i> Concave5 VERSION <label class="badge badge-primary">  {{ ucwords($version['Version']) }} </label></div>
			  		...
			  		<div class="row">
				  		...
				  		<div class="col-md-12">
							...
							<div class="authen-update available" style="display: none; background: none; padding: 20px;" >
	              				 {!! Form::open(array('url'=>'concave/server', 'class'=>'form-horizontal ','files' => true , 'parsley-validate'=>'','novalidate'=>' ' ,'id'=>'doUpdate')) !!}
	              				...
	              				<p> Please make sure you have an account at <a href="http://concave5.net" target="_blank"> Concave5.NET </a></p>
	                    		<div class="form-group">
	                    			<div class="col-md-3">
	                    				Email Address
	                    			</div>
...
$(function(){
	$('.autoupdate').on('click',function(){
		$.get('{{ url("concave/server/version?check") }}',function( callback ) {
