		...
		<div class="col-md-3 col-xs-6">
			<div class="spanel item">
				...
				<div class="panel-footer">
					<a href="http://concave5.net/product/{{ $row->Slug }}" target="_blank" class="btn btn-sm btn-default"><i class="fa fa-eye"></i> Detail </a>
					<a href="javascript://ajax" 
					onclick="ConcaveModal('{{ url("concave/server/install?id=".$row->ProductID."&t=".$row->ScriptType) }}' ,'Download & Install' ); return false;" class="btn btn-sm btn-primary"><i class="fa fa-download-cloud"></i> Download &  Install </a>
				</div>
