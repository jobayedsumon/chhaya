...
@endif
 ...
 {!! Form::open(array('url'=>'concave/form', 'class'=>'form-vertical','files' => true , 'parsley-validate'=>'','novalidate'=>' ' ,'id'=>'formField')) !!}
			...
			<td>
				<div class="input-group">
					<div class="input-group-btn ">
						<a href="{{ url('concave/form/field')}}" class="btn btn-sm btn-default" onclick="ConcaveModal(this.href,'Field Configuration'); return false;"> <i class="fa fa-question-circle"></i></a>
					</div>	
...
@if($row->formID !='')
<a href="{{ url('concave/form/preview?id='.$row->formID) }}" class="btn btn-success btn-sm" onclick="ConcaveModal(this.href,'Form Preview'); return false;"> Preview Form </a>

<a href="{{ url('concave/form/remove?id='.$row->formID) }}" class="btn btn-danger btn-sm remove"> Delete This Form </a>
@endif
