...
@section('content')
			...
			<div class="toolbar-nav">
				<a href="{{ url('concave/config/translation')}}" class="btn"> <i class="fa fa-times"></i></a>
			...
			<div class="col-md-8 offset-md-2">
				...
				@foreach($files as $f)
					...
					<li class="nav-item "   >
					<a href="{{ URL::to('concave/config/translation?edit='.$lang.'&file='.$f)}}" class="nav-link @if($file == $f) active @endif">{{ $f }} </a></li>
					@endif
				@endforeach
				</ul>
				<hr />
				{!! Form::open(array('url'=>'concave/config/savetranslation/', 'class'=>'form-vertical ')) !!}
