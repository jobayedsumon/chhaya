...
$(document).ready(function(){
	...
	$("#lookup_table").jCombo("{{ URL::to('concave/module/combotable') }}" , {
		selected_value : "<?php echo $f['option']['lookup_table'];?>" ,
		initial_text : ' Select Table',
		
	});

	$("#lookup_key").jCombo("{{ URL::to('concave/module/combotablefield') }}?table=",
 ...
 {!! Form::open(array('url'=>'concave/module/saveformfield/'.$module_name, 'class'=>'form-horizontal')) !!}
