 {!! Form::open(array('url'=>'concave/module/dobuild/'.$module_name, 'class'=>'form-horizontal','id'=>'rebuildForm')) !!}
  ...
  <div class="form-group row">
    ...
    <div class="col-md-8">
      <a href="{{ url('concave/module/rebuild/'.$module_id)}}" class="btn btn-danger" id="rebuild" ><i class="fa fa-repeat"></i> Rebuild All Codes </a> 
      </div>
  </div> 
<hr />
    <p class="text-center " style="font-weight: bold;">
