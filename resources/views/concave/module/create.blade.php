...
<div class="toolbar-nav">
  	<div class="btn-group">
  		<a href="{{ url('concave/module')}}" class="btn  btn-sm"> <i class="fa fa-times"></i> </a>
    </div>
</div>
<div class="p-5">
{!! Form::open(array('url'=>'concave/module/create/', 'class'=>'form-horizontal validated', 'parsley-validate'=>'','novalidate'=>'')) !!}
<div class="row">
