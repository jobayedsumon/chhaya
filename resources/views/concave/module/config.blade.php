...
@include('concave.module.tab',array('active'=>'config','type'=> $type))
...
<div class="p-4">
	...
	<div class="col-md-6">
	{!! Form::open(array('url'=>'concave/module/saveconfig/'.$module_name, 'class'=>'form-horizontal ','id'=>'configA' , 'parsley-validate'=>'','novalidate'=>' ')) !!}
	  ...
	  <div class=" form-group row" style="display:none;" >
		...
		<div class=" form-group row">
			...
			<div class="col-md-8 " >
						...
						<b>Form Shortcode : </b><code><br /><?php echo "[sc:Concave fnc=showForm|id=".$row->module_name."] [/sc]"; ?></code><br />
					<b>Table Shortcode : </b><br />
					<code><?php echo "[sc:Concave fnc=render|id=".$row->module_name."] [/sc]"; ?></code>
			</div> 
		</div>  	  
 ...
 @if($type !='report' && $type !='generic')
  {!! Form::open(array('url'=>'concave/module/savesetting/'.$module_name, 'class'=>'form-horizontal ' ,'id'=>'configB')) !!}
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		<?php echo ConcaveHelpers::sjForm('configA'); ?>
		<?php echo ConcaveHelpers::sjForm('configB'); ?>
