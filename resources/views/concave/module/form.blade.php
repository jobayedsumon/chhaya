...
<div class="page-header"><h2>  {{ $pageTitle }} <small>Configuration</small> </h2></div>
 @include('concave.module.tab',array('active'=>'form','type'=>  $type ))

<div class="p-3">

<ul class="nav nav-tabs" style="margin-bottom:10px;">
  	<li class="nav-item" ><a class="nav-link active" href="{{ URL::to('concave/module/form/'.$module_name)}}">Form Configuration </a></li>
  	<li class="nav-item" ><a class="nav-link" href="{{ URL::to('concave/module/subform/'.$module_name)}}">Sub Form </a></li> 
	<li class="nav-item"><a class="nav-link" href="{{ URL::to('concave/module/formdesign/'.$module_name)}}">Form Layout</a></li> 
	
</ul>


 {!! Form::open(array('url'=>'concave/module/saveform/'.$module_name, 'class'=>'form-horizontal','id'=>'fForm')) !!}
 <div class="table-responsive">
		...
		<thead class="no-border">
          ...
          <tr>
			...
			onclick="ConcaveModal('{{ URL::to('concave/module/editform/'.$row->module_id.'?field='.$rows['field'].'&alias='.$rows['alias']) }}','Edit Field : <?php echo $rows['field'];?>')">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    <?php echo ConcaveHelpers::sjForm('fForm'); ?>
