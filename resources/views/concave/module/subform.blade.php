...
@include('concave.module.tab',array('active'=>'subform'))

<div class="p-3">


<ul class="nav nav-tabs" style="margin-bottom:10px;">
    <li class="nav-item" ><a class="nav-link " href="{{ URL::to('concave/module/form/'.$module_name)}}">Form Configuration </a></li>
    <li class="nav-item" ><a class="nav-link active" href="{{ URL::to('concave/module/subform/'.$module_name)}}">Sub Form </a></li> 
  <li class="nav-item"><a class="nav-link" href="{{ URL::to('concave/module/formdesign/'.$module_name)}}">Form Layout</a></li> 
  
</ul>

  
    
    {!! Form::open(array('url'=>'concave/module/savesubform/'.$module_name, 'class'=>'form-horizontal  ','id'=>'fSubf')) !!}
        ...
        <div class="col-md-8">
          ...
          <a href="{{ url('concave/module/subformremove/'.$module_name) }}" class="btn btn-danger"><i class="icon-cancel-circle2 "></i> Remove </a>
          @endif
         </div> 
        </div> 
...
$(document).ready(function(){   
    $("#table").jCombo("{{ url('concave/module/combotable') }}",
    {selected_value : "{{ (isset($subform['table']) ? $subform['table']: null ) }}" }); 
    $("#key").jCombo("{{ url('concave/module/combotablefield') }}?table=",
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    <?php echo ConcaveHelpers::sjForm('fSubf'); ?>
