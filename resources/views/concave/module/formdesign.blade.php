...
@include('concave.module.tab',array('active'=>'form','type'=> 'addon'))

<div class="p-3">

<ul class="nav nav-tabs" style="margin-bottom:10px;">
    <li class="nav-item" ><a class="nav-link " href="{{ url('concave/module/form/'.$module_name)}}">Form Configuration </a></li>
    <li class="nav-item" ><a class="nav-link " href="{{ url('concave/module/subform/'.$module_name)}}">Sub Form </a></li> 
  <li class="nav-item"><a class="nav-link active" href="{{ url('concave/module/formdesign/'.$module_name)}}">Form Layout</a></li> 
 ...
 {!! Form::open(array('url'=>'concave/module/formdesign/'.$module_name,'id'=>'doReorder', 'class'=>'form-vertical','parsley-validate'=>'','novalidate'=>' ')) !!}
