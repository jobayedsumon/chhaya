...
<div class="page-header"><h2>  {{ $pageTitle }} <small>Configuration</small> </h2></div>
 @include('concave.module.tab',array('active'=>'sql','type'=>  $type ))

<div class="p-3">


         
          {!! Form::open(array('url'=>'concave/module/savesql/'.$module_name, 'class'=>'form-vertical ' ,'id'=>'SQL' , 'parsley-validate'=>'','novalidate'=>' ')) !!}
          <div class="infobox ">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    <?php echo ConcaveHelpers::sjForm('SQL'); ?>
