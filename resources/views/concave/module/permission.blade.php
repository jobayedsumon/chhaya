...
@include('concave.module.tab',array('active'=>'permission','type'=>$type))

<div class="p-3">

{!! Form::open(array('url'=>'concave/module/savepermission/'.$module_name, 'class'=>'form-horizontal' ,'id'=>'fPermission')) !!}
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    <?php echo ConcaveHelpers::sjForm('fPermission'); ?>
