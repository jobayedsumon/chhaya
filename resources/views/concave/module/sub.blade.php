...
<div class="page-header"><h2>  {{ $pageTitle }} <small>Configuration</small> </h2></div>
 @include('concave.module.tab',array('active'=>'sub','type'=>  $type ))

<div class="p-3">

  
    {!! Form::open(array('url'=>'concave/module/savesub/'.$module_name, 'class'=>'form-horizontal  ' ,'id'=>'fSub')) !!}
    ...
    <tbody class="no-border-x no-border-y"> 
      ...
      <tr>
        ...
        onclick="ConcaveConfirmDelete('{{ URL::to('concave/module/removesub?id='.$row->module_id.'&mod='.$rows['module']) }}');" 
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    <?php echo ConcaveHelpers::sjForm('fSub'); ?>
