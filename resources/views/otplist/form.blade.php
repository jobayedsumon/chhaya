...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'otplist?return='.$return, 'class'=>'form-horizontal validated concave-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="p-5">
		...
		<div class="row">
	<div class="col-md-12">
						<fieldset><legend> OTP List</legend>
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Otp Code" class=" control-label col-md-4 text-left"> Otp Code </label>
										<div class="col-md-6">
										  <input  type='text' name='otp_code' id='otp_code' value='{{ $row['otp_code'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
				...
				<div class="input-group input-group-sm m-b" style="width:150px !important;">
					...
					<div class="input-group-append">
					 	<div class="input-group-text"><i class="fa fa-calendar"></i></span></div>
									  ...
									  <div class="form-group row  " >
										<label for="Otp Hash" class=" control-label col-md-4 text-left"> Otp Hash </label>
										<div class="col-md-6">
										  <input  type='text' name='otp_hash' id='otp_hash' value='{{ $row['otp_hash'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("otplist/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
