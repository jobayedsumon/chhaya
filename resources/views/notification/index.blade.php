...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small></h2></div>
						...
						<div class="btn-group">
					        ...
					        <ul class="dropdown-menu">
					         ...
					         @if($access['is_remove'] ==1)
								 <li class="nav-item"><a href="javascript://ajax"  onclick="ConcaveDelete();" class="nav-link tips" title="{{ __('core.btn_remove') }}"><i class="fa fa-trash-o"></i>
			...
			<div class="table-container" >
 			{!! Form::open(array('url'=>'notification?'.$return, 'class'=>'form-horizontal m-t' ,'id' =>'ConcaveTable' )) !!}
