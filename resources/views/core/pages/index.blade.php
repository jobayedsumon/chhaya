...
<div class="">
			...
			<div class="row">
				<div class="col-md-8"> 	
					...
					<div class="btn-group">
						...
						@endif
						@if($access['is_add'] ==1)
							<li class="nav-item"><a href="{{ url($pageModule .'/import?return='.$return) }}"  class=" nav-link" onclick="ConcaveModal(this.href, 'Import CSV'); return false;"> Import CSV</a></li>
						...
						@endif	
				         ...
				         @if($access['is_remove'] ==1)
							 <li class="nav-item"><a href="javascript://ajax"  onclick="ConcaveDelete();" class="tips nav-link" title="{{ __('core.btn_remove') }}">
			...
			<div class="table-container" >
 			{!! Form::open(array('url'=>'cms/pages?'.$return, 'class'=>'form-horizontal m-t' ,'id' =>'ConcaveTable' )) !!}
							...
							<td>
							 	...
							 	<div class="dropdown">
								  ...
								  <ul class="dropdown-menu">
									...
									@if($access['is_remove'] ==1)
										 <li class="nav-item"><a href="javascript://ajax"  onclick="ConcaveDelete();" class="nav-link tips nav-link" title="{{ __('core.btn_remove') }}">
										Remove Selected </a></li>
									@endif 
								  </ul>
								</div>
