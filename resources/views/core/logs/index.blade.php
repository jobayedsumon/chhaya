...
<div class="toolbar-nav">
			<div class="row">
				<div class="col-md-8"> 	
					...
					<div class="btn-group">
						...
						@endif
						@if($access['is_add'] ==1)
							<li class="nav-item"><a href="{{ url($pageModule .'/import?return='.$return) }}" onclick="ConcaveModal(this.href, 'Import CSV'); return false;" class="nav-link"><i class="fa fa-cloud-upload"></i> Import CSV</a></li>
			...
			<!-- Table Grid -->
 			...
 			{!! Form::open(array('url'=>'core/logs?'.$return, 'class'=>'form-horizontal m-t' ,'id' =>'ConcaveTable' )) !!}
