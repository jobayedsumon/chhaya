...
<div class="">
				...
				<div class="row">
					...
					<div class="col-md-4 ">
						<div class="input-group">
						      <div class="input-group-prepend hide_on_agent">
			...
			<div class="table-container" >
 			{!! Form::open(array('url'=>'core/users?'.$return, 'class'=>'form-horizontal m-t' ,'id' =>'ConcaveTable' )) !!}
		            ...
		            @foreach ($rowData as $row)
						...
						<?php
							...
							if(\Auth::user()->group_id == 5){
								if($row->group_id == 5){
									if(\Auth::user()->hierarchy_level > $row->hierarchy_level ){
										continue;
									}
								}else{
									if(\Auth::user()->group_id > $row->group_id ){
										continue;
									}
								}
