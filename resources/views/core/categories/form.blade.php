	 ...
	 {!! Form::open(array('url'=>'cms/categories', 'class'=>'form-horizontal validated','files' => true , 'parsley-validate'=>'','novalidate'=>' ' ,'id' =>'ConcaveTable' )) !!}
   ...
   >{{ $row['desc'] }}</textarea> 
		...
		<div class="form-group" >
			<label for="Description" class=" control-label "> Alias </label>
			<div class="">
 	...
 	<div class="modal-footer inside-modal">
 		<div class="row">
 			<div class="col-md-6">
 				 <button type="button" class="btn " onclick="ConcaveDelete();"> Delete  </button>
 			</div>
