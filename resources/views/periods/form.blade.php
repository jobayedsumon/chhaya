...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'periods?return='.$return, 'class'=>'form-horizontal validated concave-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="col-md-12">
				...
				{!! Form::hidden('id', $row['id']) !!}					
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Number Of Days" class=" control-label col-md-4 text-left"> Number Of Days <span style="color:red">*</span></label>
										<div class="col-md-6">
										  <input required='' type='number' name='number_of_days' id='number_of_days' value='{{ $row['number_of_days'] }}' 
						     class='form-control form-control-sm'/> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("periods/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
