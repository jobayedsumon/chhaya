...
class InsurancecustomerController extends Controller {
	...
	public $module = 'insurancecustomer';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Insurancecustomer();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'insurancecustomer',
	...
	public static function display(  )
	{
		...
		$model  = new Insurancecustomer();
		$info = $model::makeInfo('insurancecustomer');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('insurancecustomer.public.view',$data);			
			}			
		} 
		else {
			...
			return view('insurancecustomer.public.index',$data);	
		}
