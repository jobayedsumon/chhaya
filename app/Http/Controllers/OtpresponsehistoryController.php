...
use App\Models\Otpresponsehistory;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class OtpresponsehistoryController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'otpresponsehistory';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Otpresponsehistory();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'otpresponsehistory',
	...
	public static function display(  )
	{
		...
		$model  = new Otpresponsehistory();
		$info = $model::makeInfo('otpresponsehistory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('otpresponsehistory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('otpresponsehistory.public.index',$data);	
		}
