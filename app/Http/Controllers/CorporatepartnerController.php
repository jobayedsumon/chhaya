...
class CorporatepartnerController extends Controller {
	...
	public $module = 'corporatepartner';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Corporatepartner();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'corporatepartner',
	...
	public static function display(  )
	{
		...
		$model  = new Corporatepartner();
		$info = $model::makeInfo('corporatepartner');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('corporatepartner.public.view',$data);			
			}			
		} 
		else {
			...
			return view('corporatepartner.public.index',$data);	
		}
