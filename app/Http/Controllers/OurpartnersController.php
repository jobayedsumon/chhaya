...
class OurpartnersController extends Controller {
	...
	public $module = 'ourpartners';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Ourpartners();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'ourpartners',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('ourpartners');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('ourpartners.public.view',$data);			
			}			
		} 
		else {
			...
			return view('ourpartners.public.index',$data);	
		}
