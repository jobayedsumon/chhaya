...
use App\Models\Createsalesteam;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class CreatesalesteamController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'createsalesteam';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Createsalesteam();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'createsalesteam',
	...
	public static function display(  )
	{
		...
		$model  = new Createsalesteam();
		$info = $model::makeInfo('createsalesteam');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('createsalesteam.public.view',$data);			
			}			
		} 
		else {
			...
			return view('createsalesteam.public.index',$data);	
		}
