...
class InsurancetypesController extends Controller {
	...
	public $module = 'insurancetypes';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Insurancetypes();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'insurancetypes',
	...
	public static function display(  )
	{
		...
		$model  = new Insurancetypes();
		$info = $model::makeInfo('insurancetypes');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('insurancetypes.public.view',$data);			
			}			
		} 
		else {
			...
			return view('insurancetypes.public.index',$data);	
		}
