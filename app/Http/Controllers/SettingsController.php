	...
	function store( Request $request  )
	{
		...
		switch ($task)
		{
			default:
                    ...
                    if($request->input('disabled_sales_team')){
                    
                    	if(count($request->input('disabled_sales_team')) > 1){
                    	    $data['disabled_sales_team'] = implode(',',$request->input('disabled_sales_team'));
                    	}else{
                    	    $data['disabled_sales_team'] = implode(',',$request->input('disabled_sales_team'));
                    	}
                    }else{
                        $data['disabled_sales_team'] = '';
                    }
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('settings.public.view',$data);			
			}			
		} 
		else {
			...
			return view('settings.public.index',$data);	
		}
