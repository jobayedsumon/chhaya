...
abstract class Controller extends BaseController {
	...
	public function __construct()
	{
        ...
        $this->config = $concave ;
        $this->data['concaveconfig'] = $concave ;  
	} 	
	...
	function getImport( Request $request)
	{
		...
		if($task !='')
		{
			...
			return view('concave.module.utility.import', $this->data);
		}	
	...
	public function getExpotion()
	{
		...
		return view('concave.module.utility.export', $this->data);
	}
	public function getExport( Request $request, $t = 'excel')
	{
		...
		{			
			...
			return view('concave.module.utility.csv',$content);
			
		} else if ($t == 'print') {
		
			//return view('concave.module.utility.print',$content);
	...
	function getLookup( $request)
	{
		...
		if(count($args)>=2) 
		{
			...
			$data['key']		= $info['key'];
			//$data['ids']		= 'md'-$info['id'];
			return view('concave.module.utility.masterdetail',$data);
