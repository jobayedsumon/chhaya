...
class CategoriesController extends Controller {
	...
	function create( Request $request ) 
	{
		...
		$this->data['row'] = Concave::getColumnTable( 'tb_categories'); 
		$this->data['id'] = '';
		...
		switch ($task)
		{
			...
			default:	
				...
				{			
					...
					$res = Concave::updateDataRow( 'tb_categories' ,'cid' , $data , $id  );
	...
	public function destroy( $request)
	{
		...
		if(count($request->input('ids')) >=1)
		{
			...
			$res = Concave::deleteDataRow( 'tb_categories' ,'cid' , $request->input('ids') );
