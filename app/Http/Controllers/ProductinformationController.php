...
class ProductinformationController extends Controller {
	...
	public $module = 'productinformation';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Productinformation();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'productinformation',
	...
	public static function display(  )
	{
		...
		$model  = new Productinformation();
		$info = $model::makeInfo('productinformation');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('productinformation.public.view',$data);			
			}			
		} 
		else {
			...
			return view('productinformation.public.index',$data);	
		}
