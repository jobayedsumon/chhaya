...
class MenuController extends Controller {
	...
	public function getIndex( Request $request ,$id = null  )
	{
		...
		return view('concave.menu.index',$this->data);	
	}
	...
	function postSave( Request $request, $id =0)
	{
		...
		if ($validator->passes()) {
			...
			return redirect('concave/menu?pos='.$pos)
				->with('message', 'Data Has Been Save Successfull')->with('status','success');
	...
	public function getDestroy(Request $request,$id)
	{
		...
		return redirect('concave/menu?pos='.$request->input('pos'))
	...
	{
		return view('concave.menu.icons');
