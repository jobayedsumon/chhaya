...
class FormController extends Controller {
   	...
   	public function index( Request $request )
	{
        ...
        return view('concave.form.index',$this->data);
	}
    ...
    public function show( Request $request , $task )
    {
        ...
        {
            default:
                return view('concave.form.form',$this->data);
                break;
            case 'field':
                ...
                return view('concave.form.field',$this->data);
                break;

            case 'remove':
                $id = $request->input('id');
                \DB::table('tb_forms')->where('formID',$id)->delete();
                return redirect('concave/form')->with(['status'=>'success','message'=>'Form has been deleted !']);
                break;    
            ...
            case 'update':
                ...
                if($id =='')
                {
                    $rows = Concave::getTableField('tb_forms');
                    $row = array();
                ...
                return view('concave.form.manage',$this->data);
                break;    
            case 'preview':
                $id = $request->input('id');
