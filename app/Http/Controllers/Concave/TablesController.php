...
class TablesController extends Controller 
{
   	...
   	public function index()
	{
		...
		return view('concave.tables.index',$this->data);
	}   
    ...
    public function getTableconfig( $table = null )
    {
        ...
        $this->data['action'] = ($table ==null ? 'concave/tables/tables/'.$table : 'concave/tables/tableinfo/'.$table ) ;
        return view('concave.tables.config',$this->data);
    }   
    ...
    public function postTableremove(Request $request)
    {
        ...
        if(!is_null($request->input('id')) && count($request->input('id')) >=1 )
        {
            ...
            return redirect('concave/tables')->with('message', 'Table(s) has been deleted')->with('status','success');  
        } 
        return redirect('concave/tables')->with('message','error','No Table(s) deleted !')->with('status','error');  
    ...
    public function getTablefieldedit( $table )
    {
        ...
        return view('concave.tables.field',$this->data);
    }
    ...
    public function getMysqleditor()
    {
        ...
        return view('concave.tables.editor');
    }   
