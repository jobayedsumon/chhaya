...
function ConcaveModalLarge( url , title)
{
	$('#concave-modal-lg #concave-modal-content').html(' ....Loading content , please wait ...');
	$('#concave-modal-lg  .modal-title').html(title);
	$('#concave-modal-lg  #concave-modal-content').load(url,function(){
	});
	$('#concave-modal-lg').modal('show');	
}